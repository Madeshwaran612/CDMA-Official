...
public class HangingMallakhamb extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
//    List<WifiP2pDevice> peers = new ArrayList<WifiP2pDevice>();
        ...
        generatePDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (competitionName.length() == 0) {
                    ...
                    Toast.makeText(HangingMallakhamb.this, "Competition Name is Required", Toast.LENGTH_SHORT).show();
                }
                if (EditTextAge6.length() == 0) {
                    EditTextAge6.setError("Enter Player's Age Category");
                    Toast.makeText(HangingMallakhamb.this, "Enter Player's Age Category", Toast.LENGTH_SHORT).show();
                }
                if (EditTextRepresent.length() == 0) {
                    EditTextRepresent.setError("Enter Player's Team");
                    Toast.makeText(HangingMallakhamb.this, "Enter Player's Team", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (s11.equals(ref) || s12.equals(ref) || s13.equals(ref) || s14.equals(ref) || s21.equals(ref) || s22.equals(ref) ||
                        ...
                        Toast.makeText(HangingMallakhamb.this, "Make Sure to Refresh Judges Score", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        try {
                            ...
                            Toast.makeText(HangingMallakhamb.this, "Moved To createPdf" + e, Toast.LENGTH_SHORT).show();
        ...
        createRoombut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (roomCode.getText().length() == 0||competitionName.getText().length()==0|| EditTextAge6.getText().toString().equals(age)) {
                    ...
                    Toast.makeText(HangingMallakhamb.this, "Enter Room Code & Competition name & Age Group", Toast.LENGTH_SHORT).show();
                   ...
                   collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            if (documentSnapshot.exists()) {
                                Toast.makeText(HangingMallakhamb.this, "Room Code Already Taken choose different code", Toast.LENGTH_SHORT).show();
                            } else {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (roomCode.getText().length() == 0) {
                    Toast.makeText(HangingMallakhamb.this, "Enter the Room Code", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            if (documentSnapshot.exists()) {
                                ...
                                Toast.makeText(HangingMallakhamb.this, "check room code", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
    ...
    private void createPdf(String CompName, String TeamName, String AgeGrp,
        ...
        Paragraph Apparatus = new Paragraph("Hanging Mallakhamb").setBold().setFontSize(16).setTextAlignment(TextAlignment.CENTER);
        ...
        Toast.makeText(HangingMallakhamb.this, "Pdf Created @" + pdfPath, Toast.LENGTH_SHORT).show();
        ...
        reference.child(UserEmail).child(CompName).child(TeamName).putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                databaseReference.child(f).child(CompName).setValue(url).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(HangingMallakhamb.this, "Uploaded success", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(HangingMallakhamb.this, e.toString(), Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(HangingMallakhamb.this, "firebaseDown 23" + e, Toast.LENGTH_SHORT).show();
                Log.d("SomethingWrong", e.toString());
    ...
    public float sum(float s, float d, float f, float g, float h, float j) {
        ...
        float Z = (float) (s + d + f + g - (h * 0.1) - (j * 0.5));
        return Z;
