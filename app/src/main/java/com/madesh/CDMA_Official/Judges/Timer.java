    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        returnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder build = new AlertDialog.Builder(Timer.this);
                build.setMessage("Are you sure want to exit as Timer?");
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i==1){
                    ...
                    timining.put("Total1",p1.getText().toString());
                    collectionReference.document("Timer").set(timining);
                }
                if (i==2){
                    collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    Map<String,String>timining = new HashMap<>();
                    timining.put("Total1",p1.getText().toString());
                    timining.put("Total2",p2.getText().toString());
                ...
                if (i==3){
                    ...
                    timining.put("Total1",p1.getText().toString());
                    timining.put("Total2",p2.getText().toString());
                    timining.put("Total3",p3.getText().toString());
                ...
                if (i==4){
                    ...
                    timining.put("Total2",p2.getText().toString());
                    timining.put("Total3",p3.getText().toString());
                    timining.put("Total4",p4.getText().toString());
                ...
                if (i==5){
                    ...
                    timining.put("Total3",p3.getText().toString());
                    timining.put("Total4",p4.getText().toString());
                    timining.put("Total5",p5.getText().toString());
                ...
                if (i==6){
                    ...
                    timining.put("Total4",p4.getText().toString());
                    timining.put("Total5",p5.getText().toString());
                    timining.put("Total6",p6.getText().toString());
                    collectionReference.document("Timer").set(timining);
                }
