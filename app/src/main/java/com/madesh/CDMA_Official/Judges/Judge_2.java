...
public class Judge_2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        returnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder build = new AlertDialog.Builder(Judge_2.this);
...
//                    Toast.makeText(Judge_2.this, "Competition Name is Required", Toast.LENGTH_SHORT).show();
//                }
//                if (EditTextAge6.length() == 0) {
//                    EditTextAge6.setError("Enter Player's Age Category");
//                    Toast.makeText(Judge_2.this, "Enter Player's Age Category", Toast.LENGTH_SHORT).show();
//                }
//                if (EditTextRepresent.length() == 0) {
//                    EditTextRepresent.setError("Enter Player's Team");
//                    Toast.makeText(Judge_2.this, "Enter Player's Team", Toast.LENGTH_SHORT).show();
//                } else {
//
//
...
//                        Toast.makeText(Judge_2.this, "Moved To createPdf" + e, Toast.LENGTH_SHORT).show();
...
//        });
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (competitionName.getText().length() != 0 && EditTextAge6.getText().length() != 0 && roomCode.getText().length() != 0) {
                    ...
                    Toast.makeText(Judge_2.this, "Competition Name & Room Code & Age Group Required", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (roomCode.getText().length()==0){
                    Toast.makeText(Judge_2.this, "Enter the Room Code", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            if (documentSnapshot.exists()) {
                                ...
                                Toast.makeText(Judge_2.this, "check room code", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
    ...
    private void createPdf(String CompName, String TeamName, String AgeGrp,
        ...
        Toast.makeText(Judge_2.this, "Pdf Created @" + pdfPath, Toast.LENGTH_SHORT).show();
        ...
        reference.child(UserEmail).child(CompName).child(TeamName).putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                databaseReference.child(f).child(CompName).setValue(url).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(Judge_2.this, "Uploaded success", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Judge_2.this, e.toString(), Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Judge_2.this, "firebaseDown 23" + e, Toast.LENGTH_SHORT).show();
                Log.d("SomethingWrong", e.toString());
    ...
    public void onBackPressed() {
        ...
        build.setMessage("Are you sure want to exit as Judge 2?");
        build.setCancelable(true);
        build.setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
