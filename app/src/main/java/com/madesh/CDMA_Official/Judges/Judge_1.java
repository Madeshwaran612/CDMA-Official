...
public class Judge_1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
//}
    ...
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_judge_1);
        ...
        returnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder build = new AlertDialog.Builder(Judge_1.this);
...
//                    Toast.makeText(Judge_1.this, "Competition Name is Required", Toast.LENGTH_SHORT).show();
//                }
//                if (EditTextAge6.length() == 0) {
//                    EditTextAge6.setError("Enter Player's Age Category");
//                    Toast.makeText(Judge_1.this, "Enter Player's Age Category", Toast.LENGTH_SHORT).show();
//                }
//                if (EditTextRepresent.length() == 0) {
//                    EditTextRepresent.setError("Enter Player's Team");
//                    Toast.makeText(Judge_1.this, "Enter Player's Team", Toast.LENGTH_SHORT).show();
//                } else {
//
//
...
//
//                    try {
//                        createPdf(CompName, TeamName, AgeGrp, playerName1, playerName2, playerName3, playerName4, playerName5,
//                                playerName6, grandTotal, grandTotal2, grandTotal3, grandTotal4, grandTotal5, grandTotal6);
//
//
//                    } catch (FileNotFoundException e) {
//                        Toast.makeText(Judge_1.this, "Moved To createPdf" + e, Toast.LENGTH_SHORT).show();
...
//        });
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (competitionName.getText().length() != 0 && EditTextAge6.getText().length() != 0 && roomCode.getText().length() != 0) {
                    ...
                    Toast.makeText(Judge_1.this, "Competition Name & Room Code & Age Group Required", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (roomCode.getText().length()==0){
                    Toast.makeText(Judge_1.this, "Enter the Room Code", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            if (documentSnapshot.exists()) {
                                ...
                                String Total = String.valueOf(sum(Float.parseFloat(difficulty.getText().toString()),
                                ...
                                Toast.makeText(Judge_1.this, "check room code", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
                ...
                collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()){
                            ...
                            String Total =String.valueOf(sum(Float.parseFloat(difficulty2.getText().toString()),
                                    Float.parseFloat(combination2.getText().toString()),
                                    Float.parseFloat(execution2.getText().toString()),
               ...
               collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                   ...
                   public void onSuccess(DocumentSnapshot documentSnapshot) {
                       if (documentSnapshot.exists()){
                           ...
                           String Total = String.valueOf(sum(Float.parseFloat(difficulty3.getText().toString()),
                                   Float.parseFloat(combination3.getText().toString()),
                                   Float.parseFloat(execution3.getText().toString()),
              ...
              collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                  ...
                  public void onSuccess(DocumentSnapshot documentSnapshot) {
                      if (documentSnapshot.exists()){
                          ...
                          String Total = String.valueOf(sum(Float.parseFloat(difficulty4.getText().toString()),
                                  Float.parseFloat(combination4.getText().toString()),
                                  Float.parseFloat(execution4.getText().toString()),
             ...
             collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                 ...
                 public void onSuccess(DocumentSnapshot documentSnapshot) {
                     if (documentSnapshot.exists()){
                         ...
                         String Total=String.valueOf(sum(Float.parseFloat(difficulty5.getText().toString()),
                                 Float.parseFloat(combination5.getText().toString()),
                                 Float.parseFloat(execution5.getText().toString()),
              ...
              collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                  ...
                  public void onSuccess(DocumentSnapshot documentSnapshot) {
                      if (documentSnapshot.exists()){
                          ...
                          String Total = String.valueOf(sum(Float.parseFloat(difficulty6.getText().toString()),
                                  Float.parseFloat(combination6.getText().toString()),
                                  Float.parseFloat(execution6.getText().toString()),
    ...
    private void createPdf(String CompName, String TeamName, String AgeGrp,
        ...
        Toast.makeText(Judge_1.this, "Pdf Created @" + pdfPath, Toast.LENGTH_SHORT).show();
        ...
        reference.child(UserEmail).child(CompName).child(TeamName).putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                databaseReference.child(f).child(CompName).setValue(url).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(Judge_1.this, "Uploaded success", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Judge_1.this, e.toString(), Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Judge_1.this, "firebaseDown 23" + e, Toast.LENGTH_SHORT).show();
                Log.d("SomethingWrong", e.toString());
    ...
    public float sum(float s, float d, float f, float g, float h, float j) {

        float Z = (float) (s + d + f + g) ;
        float y = Z- (h /10) - (j /2);
